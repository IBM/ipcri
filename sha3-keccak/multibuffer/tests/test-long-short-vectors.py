...
def load_nist_file(mode):
    ...
    if nist_files:
        ...
        raise InvalidFunctionNameGivenError("Invalid calltion name!")
...
def main():
    ...
    parser.add_argument('mode', type=str, help="Enter a calltion name to apply the output test 'e.g. sha3-256' : ")
